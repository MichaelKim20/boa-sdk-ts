            ...
            try {
                ...
                if (
                    ...
                    const tx = new sdk.Transaction(
                        ...
                        Buffer.from(
                            "",
                            "base64"
                        )
                    );
                    res.status(200).send(JSON.stringify(tx));
