/*******************************************************************************
    ...
    This class manages UTXO received from Stoa.
 ...
 * Manage UTXO received from Stoa used for payment and not done.
 */
...
class InternalUTXO
{
    ...
    /**
     * The height of the block that can be used
     */
    public readonly unlock_height: bigint;
