export * from 'libsodium-wrappers-m';
...
} from 'libsodium-wrappers-m';

declare module "libsodium-wrappers-sumo-m"
{
    ...
    export function crypto_scalarmult_ed25519 (scalar: Uint8Array, point: Uint8Array): Uint8Array;

    export function crypto_scalarmult_ed25519_noclamp (scalar: Uint8Array, point: Uint8Array): Uint8Array;

    export function crypto_scalarmult_ed25519_base (scalar: Uint8Array): Uint8Array;
    ...
    export function crypto_core_ed25519_is_valid_point (point: string | Uint8Array): boolean;
    ...
    export function crypto_core_ed25519_scalar_complement (scalar: string | Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
    export function crypto_core_ed25519_scalar_complement (scalar: string | Uint8Array, outputFormat: StringOutputFormat): string;

    export function crypto_core_ed25519_scalar_invert (scalar: string | Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
    export function crypto_core_ed25519_scalar_invert (scalar: string | Uint8Array, outputFormat: StringOutputFormat): string;
    ...
    export function crypto_core_ed25519_scalar_negate (scalar: string | Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
    export function crypto_core_ed25519_scalar_negate (scalar: string | Uint8Array, outputFormat: StringOutputFormat): string;
    ...
    export function crypto_core_ed25519_scalar_reduce (secret: string | Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
    export function crypto_core_ed25519_scalar_reduce (secret: string | Uint8Array, outputFormat: StringOutputFormat): string;
